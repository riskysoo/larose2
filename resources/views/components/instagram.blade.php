<div class="instagram__section section--padding color-scheme-2 pt-0">
    <div class="container">
        <div class="instagram__section--inner instagram__swiper--column5 swiper">
                        ...
                        <div class="instagram__thumbnail position__relative">
                            <a class="instagram__thumbnail--link display-block" target="_blank"
                                ...
                                <span class="instagram__social--icon"><svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <defs>
                                            <radialGradient cx="0.133" cy="1.005" r="1.305"
                                                gradientTransform="translate(0)" gradientUnits="objectBoundingBox">
                                                <stop offset="0.09" stop-color="#fa8f21" />
                                                <stop offset="0.78" stop-color="#d82d7e" />
                                            </radialGradient>
                                            <radialGradient cx="0.606" cy="1.05" r="1.029"
                                                gradientTransform="translate(0)" gradientUnits="objectBoundingBox">
