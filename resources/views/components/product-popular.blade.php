<section class="product__section section--padding color-scheme-2 pt-0">
    <div class="container">
        ...
        <div class="product__section--container">
            <div class="row">
                <div class="col-lg-5 col-md-8 col-md-order offset-md-2 offset-lg-0">
                    <div class="product__banner">
                        <a class="product__banner--thumbnail display-block position__relative" href="shop.html"><img
                                class="product__banner--thumbnail__img display-block"
                                src="{{ asset('ggm/assets/img/banner/banner18.webp') }}" alt="banner-img">
                            <div class="product__banner--content">
                                <h4 class="product__banner--content__subtitle text-white">Limited Price Offer!
                                </h4>
                                <h3 class="product__banner--content--title text-white">Summer Sofa Offer <br>
                                    Don't Miss Deal </h3>
                                <span class="product__banner--content__price text-white">$250.00</span>
                            </div>
                        </a>
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="product__section--inner product__swiper--grid  product__swiper--column3 swiper">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="product__items ">
                                    ...
                                    <div class="product__items--content product__content--style2 text-center">
                                ...
                                <div class="product__items ">
                                    ...
                                    <div class="product__items--content product__content--style2 text-center">
                                        ...
                                        <a class="product__items--content__tag"
                                            href="product-details.html">Chair</a>
                                        <h3 class="product__items--content__title h4"><a
                                                href="product-details.html">Modern Swivel Chair</a></h3>
                                        <div class="product__items--price">
                                            <span class="current__price">$160.00</span>
                        ...
                        <div class="swiper__nav--btn style2 swiper-button-next"></div>
                        <div class="swiper__nav--btn style2 swiper-button-prev"></div>
                    </div>
                </div>
            </div>
        </div>
