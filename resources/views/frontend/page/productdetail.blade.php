                ...
                <div class="row row-cols-1">
                    <div class="col">
                        <div class="breadcrumb__content">
                            <h1 class="breadcrumb__content--title text-white mb-10">{{ $product->name }}
                            </h1>
                            <ul class="breadcrumb__content--menu d-flex">
                                <li class="breadcrumb__content--menu__items"><a class="text-white"
                                        href="{{ route('landing-page') }}" title="Home Page">Home</a></li>
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    {{-- <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox"
                                                data-gallery="product-media-preview"
                                                href="{{ asset('ggm/assets/img/product/big-product3.webp') }}"><img
                                                    class="product__media--preview__items--img"
                                                    src="{{ asset('ggm/assets/img/product/big-product3.webp') }}"
                                                    alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox"
                                                    href="{{ asset('ggm/assets/img/product/big-product3.webp') }}"
                                                    data-gallery="product-media-preview">
                                                    <svg class="product__media--view__icon--svg"
                                                        xmlns="http://www.w3.org/2000/svg" width="22.51"
                                                        height="22.443" viewBox="0 0 512 512">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox"
                                                data-gallery="product-media-preview"
                                                href="{{ asset('ggm/assets/img/product/big-product4.webp') }}"><img
                                                    class="product__media--preview__items--img"
                                                    src="{{ asset('ggm/assets/img/product/big-product4.webp') }}"
                                                    alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox"
                                                    href="{{ asset('ggm/assets/img/product/big-product4.webp') }}"
                                                    data-gallery="product-media-preview">
                                                    <svg class="product__media--view__icon--svg"
                                                        xmlns="http://www.w3.org/2000/svg" width="22.51"
                                                        height="22.443" viewBox="0 0 512 512">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox"
                                                data-gallery="product-media-preview"
                                                href="{{ asset('ggm/assets/img/product/big-product5.webp') }}"><img
                                                    class="product__media--preview__items--img"
                                                    src="{{ asset('ggm/assets/img/product/big-product5.webp') }}"
                                                    alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox"
                                                    href="{{ asset('ggm/assets/img/product/big-product5.webp') }}"
                                                    data-gallery="product-media-preview">
                                                    <svg class="product__media--view__icon--svg"
                                                        xmlns="http://www.w3.org/2000/svg" width="22.51"
                                                        height="22.443" viewBox="0 0 512 512">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox"
                                                data-gallery="product-media-preview"
                                                href="{{ asset('ggm/assets/img/product/big-product6.webp') }}"><img
                                                    class="product__media--preview__items--img"
                                                    src="{{ asset('ggm/assets/img/product/big-product6.webp') }}"
                                                    alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox"
                                                    href="{{ asset('ggm/assets/img/product/big-product6.webp') }}"
                                                    data-gallery="product-media-preview">
                                                    <svg class="product__media--view__icon--svg"
                                                        xmlns="http://www.w3.org/2000/svg" width="22.51"
                                                        height="22.443" viewBox="0 0 512 512">
                            ...
                            <div class="product__media--nav swiper">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img"
                                                src="{{ asset('ggm/assets/img/product/small-product2.webp') }}"
                                                alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img"
                                                src="{{ asset('ggm/assets/img/product/small-product3.webp') }}"
                                                alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img"
                                                src="{{ asset('ggm/assets/img/product/small-product4.webp') }}"
                                                alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img"
                                                src="{{ asset('ggm/assets/img/product/small-product5.webp') }}"
                                                alt="product-nav-img">
                                        </div>
                                    </div> --}}
                                    @foreach ($product->galleries as $gallery)
                    ...
                    <div class="col">
                        <div class="product__details--info">
                            <form action="#">
                                ...
                                <div class="product__variant">
                                    ...
                                    <div class="product__variant--list mb-15">
                                        <div class="product__details--info__meta">
                                            <p class="product__details--info__meta--list"><strong>Code:</strong>
                                ...
                                <div class="product__variant--list mb-15 mt-5">
                                ...
                                <div class="guarantee__safe--checkout">
                                    <img class="guarantee__safe--checkout__img"
                                        src="{{ asset('ggm/assets/img/other/safe-checkout.webp') }}"
                                        alt="Payment Image">
                                </div>
                            </form>
                        </div>
